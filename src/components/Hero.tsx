...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[800px] sm:min-h-[860px] flex flex-col items-center justify-between px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 bg-skyz-bg transition-colors duration-200">
      {/* Top Meta Chip */}
      <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-skyz-surface shadow-sm border border-skyz-border">
        <span className="w-2 h-2 rounded-full bg-skyz-accent animate-ping" />
      ...
      {/* Main Center Content */}
      <div className="w-full max-w-4xl mx-auto text-center flex flex-col items-center justify-center my-auto py-8">
        <h1 className="font-display text-4xl sm:text-6xl md:text-7xl lg:text-[5.25rem] lg:leading-[5.5rem] text-skyz-text tracking-tighter max-w-4xl mx-auto font-bold leading-tight">
          We build{' '}
        ...
        <p className="text-base sm:text-lg md:text-xl text-skyz-text-muted max-w-2xl mx-auto mt-5 text-center font-normal px-2 leading-relaxed">
          Synthesizing high-performance web applications, targeted digital growth engines, and autonomous AI automation for forward-thinking businesses.
        </p>

        {/* HERO SEARCH PILL */}
        <div className="w-full max-w-2xl mt-9 sm:mt-12 px-2 sm:px-0">
